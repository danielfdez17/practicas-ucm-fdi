...
public class Main {
	...
	private static void initFactories() {
		...
		ArrayList<Builder<ForceLaws>> forceBuilder = new ArrayList<>();
		bodyBuilders.add(new MovingBodyBuilder());
		bodyBuilders.add(new StationaryBodyBuilder());
		forceBuilder.add(new NewtonUniversalGravitationBuilder());
		forceBuilder.add(new NoForceBuilder());
		forceBuilder.add(new MovingTowardsFixedPointBuilder());
		_bodyFactory = new BuilderBasedFactory<Body>(bodyBuilders);
		_forceLawsFactory = new BuilderBasedFactory<ForceLaws>(forceBuilder);
	}
	...
	private static Options buildOptions() {
		...
		// steps
		cmdLineOptions.addOption(Option.builder("s").longOpt("steps").hasArg().desc("Number of repetitions").build());
