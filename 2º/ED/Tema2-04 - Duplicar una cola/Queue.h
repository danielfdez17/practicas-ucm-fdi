...
public:
	...
	//////////////////////////////////////////////////////////
	// MODIFICACIONES
	// El coste del algoritmo es lineal en el numero de elementos de la cola antes de llamar a la funcion duplica
	void duplica() {
		Nodo* n = prim, *antn = nullptr;
		while (n != nullptr) {
			antn = n;
			n = n->sig;
			if (n == nullptr) ult = antn;
			antn->sig = new Nodo(antn->elem, n);
		}
	}
	//////////////////////////////////////////////////////////
