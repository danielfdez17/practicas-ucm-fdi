...
public class GUIBuscarProveedor extends JFrame implements GUI {
	private static final String FROM_WHERE = "GUIBuscarProveedor";
	private JTextField textId;
	private static GUIBuscarProveedor instancia;
	
	public GUIBuscarProveedor() {
		this.initGUI();
	}
	
	public synchronized static GUIBuscarProveedor getInstancia() {
		if (instancia == null) instancia = new GUIBuscarProveedor();
		return instancia;
	}
		...
		buttonBaja.addActionListener((e) -> {
			if (!this.areTextFieldsEmpty()) {
				try {
					...
					setVisible(false);
					this.clear();
					Controlador.getInstancia().accion(new Context(Eventos.BUSCAR_PROVEEDOR, id));
	...
	public void update(Context context) {
		...
		case BUSCAR_PROVEEDOR_OK:
			TProveedor p = (TProveedor)context.getDatos();
			GUIMSG.showMessage("Proveedor encontrado\n" + p.toString(), FROM_WHERE, false);
			break;
		case BUSCAR_PROVEEDOR_KO:
			GUIMSG.showMessage("El proveedor no existe", FROM_WHERE, true);
			break;
		default:
